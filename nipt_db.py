...
class Sample(db.Model):
	...
	def __init__(self, nipt_dict, batch):
		...
		self.status_T13 = 'Suspected'
		self.status_T18 = 'Suspected'
		self.status_T21 = 'Suspected'
		self.status_X0 = 'Suspected'
		self.status_XX = 'Suspected'
		self.status_XXY = 'Suspected'
		self.status_XYY = 'Suspected'
		self.status_XXX = 'Suspected'
